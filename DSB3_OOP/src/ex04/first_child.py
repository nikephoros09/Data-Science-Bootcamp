...
if __name__ == '__main__':
    ...
    raw_count = research.file_reader()
    print(raw_count)
    analysis = Research.Analytics(raw_count)
    heads, tails = analysis.counts()
    print(f'{heads} {tails}')
    heads_percent, tails_percent = analysis.fractions(heads, tails)
    print(heads_percent, tails_percent)
